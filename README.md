...
特定の二重母音と追加音の組み合わせはマイナーな二重母音に変換されます
...
※ 上一段、下一段として存在しない動詞の場合はラ行の五段活用になります
...
---
#### 特殊略語(Special Abbreviations)
特殊略語は、特別な変換ルールを持つ語を入力するために使います
...
##### かな+助詞
どの略語にも登録されておらず、かつ上記の条件に当てはまらない場合は助詞を追加します
